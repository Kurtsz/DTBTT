...
def main():
    init(convert=True) # konsol desteği ANSI kaçış renk kodlarını yapar
...
|_   _| | | |_   _|                                                         
  ...
  \_/ \_| |_/ \_/                                                           
   ...
   {1}Discord Token Bilgi Toplama Toolu
          {4}Made By Bozkurts{2}
    ...
    if len(sys.argv) == 2:
        ...
        try:
            ...
            if res.status_code == 200: # code 200 if valid
                ...
                print('-----------------')
                print(f'    {Fore.RESET}Kullanıcı adı               {Fore.GREEN}{user_name}')
                print(f'    {Fore.RESET}Kullanıcı ID                {Fore.GREEN}{user_id}')
                print(f'    {Fore.RESET}Oluşturulma Tarihi          {Fore.GREEN}{creation_date}')
                ...
                print('Nitro Bilgisi')
                print('-----------------')
                print(f'    {Fore.RESET}Nitro Durumu           {Fore.MAGENTA}{has_nitro}')
                if has_nitro:
                    print(f'    {Fore.RESET}Expires in             {Fore.MAGENTA}{days_left} day(s)')
                print(f'{Fore.RESET}\n')


                print('İletişim Bilgisi')
                print('-------------------')
                print(f'    {Fore.RESET}Telefon numarası           {Fore.YELLOW}{phone_number if phone_number else ""}')
                print(f'    {Fore.RESET}E-posta                  {Fore.YELLOW}{email if email else ""}')
                print(f'{Fore.RESET}\n')

                if len(billing_info) > 0:
                    print('Faturalandırma Bilgisi')
                    print('-------------------')
                ...
                print('Hesap Güvenliği')
                print('----------------')
                print(f'    {Fore.RESET}2FA/MFA Etkinleştirilmiş        {Fore.BLUE}{mfa_enabled}')
                print(f'    {Fore.RESET}Bayrak                          {Fore.BLUE}{flags}')
                print(f'{Fore.RESET}\n')

                print('Diğer')
                print('-----')
                print(f'    {Fore.RESET}Yerel Ayar/Ülke                {Fore.RED}{locale} ({language})')
                print(f'    {Fore.RESET}E-posta doğrulaması            {Fore.RED}{verified}')
